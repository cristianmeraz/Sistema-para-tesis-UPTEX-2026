                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div style="position:relative;">
                                    <input type="password" name="password" id="password" class="form-control bg-light border-0 py-2" required placeholder="Mínimo 8 caracteres" style="padding-right:2.8rem;">
